      ...
      .then((response) => {
        if (response.status === 200) {
          ...
          for (const [key, value] of Object.entries(apidata)) {
            switch (key) {
              case "banner_title":
                formik.setFieldValue("banner_title", value);
                break;
              case "banner_image":
                formik.setFieldValue("banner_image", value);
                break;
              case "banner_category":
                formik.setFieldValue("banner_category", value);
                break;
              default:
                break;
            }
        ...
        <>
          ...
          <Row className="mt-4">
            <Col md={6} style={{ textAlign: "left" }}>
              <h3 style={{ height: "40px" }}>Add Banner</h3>
            </Col>
            <Col md={4}></Col>
