...
const Contant = () => {
            ...
            await apiAdminConfig
                ...
                .then((response) => {
                    ...
                    if (response?.data?.status === true) {
                        ...
                        setTimeout(() => {
                            navigate("/master/leadmanagement", { replace: true });
                          }, 1000);
                    }
                })
                .catch((error) => {
    ...
    const fetchLead = async (_id) => {
        setLoader(true);
        await apiAdminConfig
            .get(`leadmanagement/${_id}`)
            .then((response) => {
                if (response.status === 200) {
                      ...
                      for (const [key, value] of Object.entries(resp)) {
                        if (key === "user_number") {
                          ...
                          formik.setFieldValue(`specialization`, value);
                            ...
                            formik.setFieldValue(`clinic`, value._id);
                          }
                        else {
            ...
            {loader ? (
                ...
                <Row className="mt-4">
                    <Col md={6} style={{ textAlign: "left" }}>
                        <h3 style={{ height: "40px" }}>Edit Leads</h3>
                    </Col>
                    <Col md={4}></Col>
